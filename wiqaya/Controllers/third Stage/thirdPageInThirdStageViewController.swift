//
//  thirdPageInThirdStageViewController.swift
//  wiqaya
//
...
class thirdPageInThirdStageViewController: UIViewController {
...
extension thirdPageInThirdStageViewController: AVCapturePhotoCaptureDelegate {
           ...
           let image = UIImage(data: imageData) {
            ...
            if isPhotoPerfect {
                DispatchQueue.main.asyncAfter(deadline: .now() + 2.0) {
                    self.performSegue(withIdentifier: "goToFavePhotoPageInThirdStage", sender: self)
                }
            } else {
