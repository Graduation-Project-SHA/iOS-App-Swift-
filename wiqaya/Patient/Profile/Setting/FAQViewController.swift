...
class FAQViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UIGestureRecognizerDelegate {
    ...
    func implement () {
        ...
        array.append(FAQModel(question: "كم من الوقت سيستغرق موعد طبيبي؟", answer: "عادةً ما يستغرق الموعد بين 15 إلى 30 دقيقة، اعتمادًا على سبب الزيارة وعدد الاستفسارات أو الفحوص التي قد تحتاجها. قد يستغرق الموعد وقتًا أطول إذا كانت هناك حاجة لتحاليل أو تقييمات إضافية."))
        array.append(FAQModel(question: "كم سيكلّف موعد طبيبي؟", answer: "تختلف تكلفة الموعد حسب نوع الزيارة، والطبيب، والمركز الطبي، ونظام التأمين الخاص بك. يمكنك معرفة التكلفة الدقيقة بالتواصل مع العيادة مسبقًا أو مراجعة تفاصيل التأمين لمعرفة ما يغطيه وما لا يغطيه."))
        array.append(FAQModel(question: "ما الذي يجب أن أبحث عنه عند الطبيب الجيد؟", answer: "الطبيب الجيد يتميّز بالاستماع الجيد، والاهتمام بحالتك، وشرح المعلومات بطريقة واضحة ومطمئنة. كما يجب أن يكون لديه خبرة في مجاله، وأن يقدّم خطط علاجية مناسبة لك مع مراعاة تاريخك الصحي. كذلك من المهم أن تشعر بالراحة والثقة أثناء التعامل معه."))
    }
